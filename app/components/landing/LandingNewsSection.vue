        ...
        <div class="relative mx-auto max-w-7xl">
            ...
            <div class="mb-14">
                ...
                <p class="mt-5 max-w-2xl text-zinc-600">
                    Explore the latest operational updates, sustainability
                    initiatives, and strategic developments across our integrated
                    nickel ecosystem.
                </p>
            </div>
            ...
            <div v-else class="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
                <NuxtLink v-for="news in newsItems" :key="news.slug" :to="`/news/${news.slug}`"
                    ...
                    <div class="p-5">
                        ...
                        <h3
                            class="mt-2 text-2xl font-semibold leading-snug text-zinc-900 transition group-hover:text-amber-600">
                            {{ news.title }}
                        </h3>
