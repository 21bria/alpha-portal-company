...
<template>
  <main class="relative min-h-screen overflow-hidden bg-white px-6 pt-30 pb-20 text-black">
    <div
    ...
    <section class="relative mx-auto max-w-7xl">
      <div v-if="pending" class="py-24 text-center text-zinc-500">
        Loading...
      </div>
      ...
      <template v-else>
          ...
          <div>
            ...
            <div class="mt-10 flex flex-wrap gap-4">
              ...
              <NuxtLink
                ...
                :to="hero?.data?.secondary_button_url || '#'"
        ...
        <div v-if="benefitsSection" class="mt-24">
          <div class="text-center">
            <p
              v-if="benefitsSection.data?.eyebrow"
              class="text-xs font-semibold uppercase tracking-[0.35em] text-amber-600"
            >
        ...
        <div id="positions" class="mt-16">
          ...
          <div class="mt-5 space-y-4">
            ...
            >
              ...
              <span class="text-sm font-semibold text-amber-600 transition group-hover:translate-x-1">
                View role →
              </span>
            </NuxtLink>
          </div>
